    ...
    <fo:table table-layout="fixed" font-style="normal" width="100%" border-collapse="collapse">
      ...
      <fo:table-header>
        <fo:table-row line-height="{$s_table_header_height}"  height="{$s_table_header_height}">
          ...
          <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block font-style="italic" text-align="center">Обозначение</fo:block></fo:table-cell>
          <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block font-style="italic" text-align="center">Наименование</fo:block></fo:table-cell>
          <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block-container height="9.8mm" reference-orientation="90" inline-progression-dimension="from-parent(line-height)" display-align="center" line-height="4mm"><fo:block text-align="center" font-style="italic" font-size="4mm">Кол.</fo:block></fo:block-container></fo:table-cell>
          <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block-container height="14.6mm" line-height="6.7mm" display-align="center"><fo:block font-style="italic" text-align="center">Приме-</fo:block><fo:block font-style="italic" text-align="center">чание</fo:block></fo:block-container></fo:table-cell>
        </fo:table-row>
      </fo:table-header>
...
<xsl:template name="Little_stamp">
    ...
    <xsl:param name="Dokum"/>
              <fo:table table-layout="fixed" width="100%" border-collapse="collapse" font-style="normal" line-height="4.45mm">
                  ...
                  <fo:table-cell border-width="0.5mm" border-style="solid" number-rows-spanned="3">
                     ...
                     <fo:table table-layout="fixed" width="100%" border-collapse="collapse" line-height="1.5 * 4.45mm">
                         <fo:table-body>
                             ...
                             <fo:table-cell border-width="0.0mm 0.0mm 0.5mm 0.0mm" border-style="solid"><fo:block font-style="italic" text-align="center">Лист</fo:block></fo:table-cell>
                             </fo:table-row>
                             <fo:table-row height="6.670mm">
                             <fo:table-cell border-width="0.5mm 0.0mm 0.0mm 0.0mm" border-style="solid"><fo:block font-style="italic" text-align="center"><fo:page-number/></fo:block></fo:table-cell>
                             </fo:table-row>
                         </fo:table-body>
                     </fo:table>
                ...
                <fo:table-row height='from-parent(height)'>
                  <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block font-style="italic" text-align="center">Изм.</fo:block></fo:table-cell>
                  <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block font-style="italic" text-align="center">Лист</fo:block></fo:table-cell>
                  <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block font-style="italic" text-align="center">№ докум.</fo:block></fo:table-cell>
                  <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block font-style="italic" text-align="center">Подп.</fo:block></fo:table-cell>
                  <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block font-style="italic" text-align="center">Дата</fo:block></fo:table-cell>
                  <!-- Spanned cells number-rows-spanned="3"  -->
                  <!-- Spanned cells number-rows-spanned="3"  -->
                </fo:table-row>
                </fo:table-body>
...
<xsl:template name="Gross_stamp">
	...
	<xsl:param name="pageQty"/>
              ...
              <fo:table table-layout="fixed" width="100%" border-collapse="collapse" font-style="normal" line-height="(40.0mm div 8) - 0.5mm">
                ...
                <fo:table-row height='from-parent(height)'>
                  <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block/><xsl:if test="not(contains($Izm,'00'))"><fo:block font-style="italic" text-align="center"><xsl:value-of select="$Izm"/></fo:block></xsl:if></fo:table-cell>
                  <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block/></fo:table-cell>
                  <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block font-style="italic" text-align="center"><xsl:value-of select="$Dokum"/></fo:block></fo:table-cell>
                  <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block/></fo:table-cell>
                  <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block/></fo:table-cell>
                  <!-- Spanned sells number-columns-spanned="6" number-rows-spanned="3" -->
                  <!-- Spanned sells number-columns-spanned="6" number-rows-spanned="3" -->
                ...
                <fo:table-row height='from-parent(height)'>
                  <fo:table-cell border-width="0.5mm" border-style="solid" number-columns-spanned="2"><fo:block font-style="italic" margin-left="0.5mm">Разраб.</fo:block></fo:table-cell>
                  <!-- Spanned cell -->
                  <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block font-style="italic" margin-left="0.5mm" font-size="2.5mm"><xsl:value-of select="$Razr"/></fo:block></fo:table-cell>
                  <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block/></fo:table-cell>
                  <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block font-style="italic" text-align="center" font-size="2.5mm"><xsl:value-of select="$crtDate"/></fo:block></fo:table-cell>
                  ...
                  <fo:table-cell border-width="0.5mm" border-style="solid" number-columns-spanned="3"><fo:block font-style="italic" text-align="center">Лит.</fo:block></fo:table-cell>
                  <!-- Spanned sells number-columns-spanned="3" -->
                  <!-- Spanned sells number-columns-spanned="3" -->
                  <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block font-style="italic" text-align="center">Лист</fo:block></fo:table-cell>
                  <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block font-style="italic" text-align="center">Листов</fo:block></fo:table-cell>
                </fo:table-row>

                <fo:table-row height='from-parent(height)'>
                  <fo:table-cell border-width="0.5mm" border-style="solid" number-columns-spanned="2"><fo:block font-style="italic" margin-left="0.5mm">Пров.</fo:block></fo:table-cell>
                  <!-- Spanned cells number-columns-spanned="2" -->
                  <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block font-style="italic" margin-left="0.5mm" font-size="2.5mm"><xsl:value-of select="$Prov"/></fo:block></fo:table-cell>
                  <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block/></fo:table-cell>
                  <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block font-style="italic" text-align="center" font-size="2.5mm"><xsl:value-of select="$chkDate"/></fo:block></fo:table-cell>
                  ...
                  <!--fo:table-cell border-width="0.5mm" border-style="solid"><fo:block/></fo:table-cell>
                  <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block/></fo:table-cell-->
                  <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block font-style="italic" text-align="center">
                        <!-- Uncomment to hide page number on first page -->
						<!--xsl:if test = "$pageQty>'1'"-->
                            <fo:page-number/>
                        <!--/xsl:if-->
                  </fo:block></fo:table-cell>
                  <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block font-style="italic" text-align="center"><fo:page-number-citation ref-id="LastPage"/></fo:block></fo:table-cell>
                </fo:table-row>
                ...
                <fo:table-row height='from-parent(height)'>
                  <fo:table-cell border-width="0.5mm" border-style="solid" number-columns-spanned="2"><fo:block font-style="italic" margin-left="0.5mm">Н.контр.</fo:block></fo:table-cell>
                  <!-- Spanned cells number-columns-spanned="2" -->
                  <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block font-style="italic" margin-left="0.5mm" font-size="2.5mm"><xsl:value-of select="$Norm"/></fo:block></fo:table-cell>
                  <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block/></fo:table-cell>
                  <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block font-style="italic" text-align="center" font-size="2.5mm"><xsl:value-of select="$ctrlDate"/></fo:block></fo:table-cell>
                  <!-- Spanned cells number-rows-spanned="5" -->
                  <!-- Spanned cells number-rows-spanned="3" -->
                  <!-- Spanned cells number-rows-spanned="3"  number-rows-spanned="3"  -->
                  <!-- Spanned cells number-rows-spanned="3"  number-rows-spanned="3"  -->
                ...
                <fo:table-row height='from-parent(height)'>
                  <fo:table-cell border-width="0.5mm" border-style="solid" number-columns-spanned="2"><fo:block font-style="italic" margin-left="0.5mm">Утв.</fo:block></fo:table-cell>
                  <!-- Spanned cell -->
                  <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block font-style="italic" margin-left="0.5mm" font-size="2.5mm"><xsl:value-of select="$Utv"/></fo:block></fo:table-cell>
                  <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block/></fo:table-cell>
                  <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block font-style="italic" text-align="center" font-size="2.5mm"><xsl:value-of select="$aprDate"/></fo:block></fo:table-cell>
                  <!-- Spanned cells number-rows-spanned="5" -->
                  <!-- Spanned cells number-rows-spanned="3" -->
                  <!-- Spanned cells number-rows-spanned="3"  number-rows-spanned="3"  -->
                  <!-- Spanned cells number-rows-spanned="3"  number-rows-spanned="3"  -->
      ...
      <fo:table-column column-width="57mm"/>
              <fo:table-body  border-width="0.5mm 0.5mm 0.5mm 0.5mm">
                 <fo:table-row  height="4.5mm" border-width="0.5mm">
                   <fo:table-cell border-width='from-parent(border-width)' border-style="solid"><fo:block font-style="italic" text-align="center" margin-top="0.5mm" font-size="3mm">Справ. №</fo:block></fo:table-cell>
                   <fo:table-cell border-width='from-parent(border-width)' border-style="solid"><fo:block font-style="italic" text-align="center" margin-top="0.5mm" font-size="3mm">Перв. примен.</fo:block></fo:table-cell>
                 </fo:table-row>
                 <fo:table-row  height="6.5mm" border-width="0.5mm">
                   ...
                   <fo:table-cell wrap-option="no-wrap" border-width='from-parent(border-width)' border-style="solid"><fo:block font-style="italic" text-align="center" font-size="5.0mm" margin-top="0.25mm" margin-bottom="0.25mm"><xsl:value-of select="$PervPrimen"/></fo:block></fo:table-cell>
                 </fo:table-row>
              </fo:table-body>
    </fo:table>
</xsl:template>
...
<xsl:template name="Add_main_stamp_gost_2104_68">
    ...
    <fo:table table-layout="fixed" font-style="normal" width="100%" border-collapse="collapse">
      ...
      <fo:table-column column-width="35mm"/>
              <fo:table-body  border-width="0.5mm 0.5mm 0.5mm 0.5mm">
                 <fo:table-row  height="4.5mm" border-width="0.5mm">
                   <fo:table-cell border-width='from-parent(border-width)' border-style="solid"><fo:block font-style="italic" text-align="center" margin-top="0.5mm" font-size="3mm">Инв. № подл.</fo:block></fo:table-cell>
                   <fo:table-cell border-width='from-parent(border-width)' border-style="solid"><fo:block font-style="italic" text-align="center" margin-top="0.5mm" font-size="3mm">Подп. и дата</fo:block></fo:table-cell>
                   <fo:table-cell border-width='from-parent(border-width)' border-style="solid"><fo:block font-style="italic" text-align="center" margin-top="0.5mm" font-size="3mm">Взам. инв. №</fo:block></fo:table-cell>
                   <fo:table-cell border-width='from-parent(border-width)' border-style="solid"><fo:block font-style="italic" text-align="center" margin-top="0.5mm" font-size="3mm">Инв. № дубл.</fo:block></fo:table-cell>
                   <fo:table-cell border-width='from-parent(border-width)' border-style="solid"><fo:block font-style="italic" text-align="center" margin-top="0.5mm" font-size="3mm">Подп. и дата</fo:block></fo:table-cell>
                 </fo:table-row>
                 <fo:table-row  height="6.5mm" border-width="0.5mm">
